...
window.ShearPhoto.prototype = {
          ...
          preview:{
                    ...
                    run:function(arg, thisMain) {
                              ...
                              if (Object.prototype.toString.call(arg.preview) === "[object Array]") {
                                        var leng = arg.preview.length, EmptyFun = function() {}, srcDefault = arg.relativeUrl + "img/default.gif";
                                        if (leng > 0) {
          ...
          config:function(arg) {
                    ...
                    this.pointhandle(3e3, 10, "请选择本地照片进行操作", 2, "#307ff6", "#fff");
          },
          zoom:function() {
                    ...
                    this.MyAjax.carry({
                              ...
                              success:function(queryId) {
                                    if (queryId == null ||queryId=='') {
                                              this_.SendUserMsg("发生错误！请与管理员联系！", 5e3, 0, "#f4102b", "#fff", false);
                                              return;
                                    }
                                    window.location="compare/page?queryId="+queryId;
